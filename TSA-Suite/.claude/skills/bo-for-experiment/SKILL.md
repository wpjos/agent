...
- `.claude/skills/bo-for-experiment/references/hebo_api.md` — HEBO DesignSpace / GeneralBO 接口说明
- `.claude/skills/bo-for-experiment/references/experiment_guide.md` — 实验容错与健壮性指南
- `.claude/skills/bo-for-experiment/references/scenario_examples.md` — 完整使用示例（单目标 / 多目标）
